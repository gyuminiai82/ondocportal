...
public class CrmOperationScheduleVO {
	String ptno = "";
	String name = "";
	String cen = "";
	String resno = "";
	...
	String doctor_id = "";
	String visit_type = "";
	String sms_send_check = "";
	String customer_memo = "";
	String reserve_type = "";
	String rev_bookingkey = "";
	String rev_reservationkey = "";
	String reserve_memo = "";
	String cancel_memo = "";
	String item_arr = "";
	...
	//예약스케줄 모달에서 부서/부서번호/예약시간 중 하나라도 수정시
	String action_type = "";
	...
	public String getSetcolor_idx() {
		return setcolor_idx;
	}
	public void setSetcolor_idx(String setcolor_idx) {
		this.setcolor_idx = setcolor_idx;
	}
	...
	public String getSms_send_check() {
		return sms_send_check;
	}
	public void setSms_send_check(String sms_send_check) {
		this.sms_send_check = sms_send_check;
	}
	...
	public String getRev_bookingkey() {
		return rev_bookingkey;
	}
	public void setRev_bookingkey(String rev_bookingkey) {
		this.rev_bookingkey = rev_bookingkey;
	}
	public String getRev_reservationkey() {
		return rev_reservationkey;
	}
	public void setRev_reservationkey(String rev_reservationkey) {
		this.rev_reservationkey = rev_reservationkey;
	}
