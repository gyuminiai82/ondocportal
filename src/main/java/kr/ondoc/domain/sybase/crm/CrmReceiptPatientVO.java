...
public class CrmReceiptPatientVO {
	String ptno = "";		//차트번호
	//접수정보
	String regno = "";		//접수일련번호
	...
	String rwj_jin_kind = ""; /* 0:신환,1:과초진,2:초진,5:재진,6:물리치료,7:가족내원,8:대리내원 */
	...
	public String getRwj_jin_kind() {
		return rwj_jin_kind;
	}
	public void setRwj_jin_kind(String rwj_jin_kind) {
		this.rwj_jin_kind = rwj_jin_kind;
	}
}
