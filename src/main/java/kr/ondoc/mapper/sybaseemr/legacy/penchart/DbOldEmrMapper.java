...
public interface DbOldEmrMapper {
	@Select("<script>"
			...
			+ "</if>"
			+ "</script>")
	public EmrSavedDataVO selectLockCheck(EmrOldParamVO vo) throws Exception;
	
	@Select("<script>"
			+ "SELECT oec_ptno, oec_seq, oec_lockyn, oec_lockdt, oec_emr AS sheet, "
			...
			+ "</if>"
			+ "</script>")
	public List<EmrSavedDataVO> selectSavedEmr(EmrOldParamVO vo) throws Exception;
	...
	@Update("<script>"
			...
			+ "</if>"
			+ "</script>")
	public void updateSavedEmr(EmrOldParamVO vo) throws Exception; 
	...
	@Update("<script>"
			...
			+ "AND oec_lockyn='0'"
			+ "</script>")
	public void updateEmrLock(EmrOldParamVO vo) throws Exception; 
	...
	@Insert("<script>"
			...
			+ "#{inout}, "
			+ "#{bes_id}, "
			+ "(SELECT be2_id FROM emrchart_list ecl LEFT OUTER JOIN emrchart_list2 ecl2 ON ecl.bec_id=ecl2.be2_id AND ecl.bec_inout=#{inout} WHERE ecl.bec_kind=#{kind} AND be2_no=#{bes_id}), "
	...
	@Update("<script>"
			...
			+ "AND oec_seq = #{key}"
			+ "</script>")
	public void updateNewEmr(EmrNewPageVO vo) throws Exception; 
	...
	@Delete("<script>"
			...
			+ "AND oec_seq = #{key}"
			+ "</script>")
	public void deleteNewEmr(EmrNewPageVO vo) throws Exception; 
	...
	@Select("<script>"
			...
			+ "</script>")
	public List<EmrNewDataVO> selectPage(EmrNewPageVO vo) throws Exception;
	...
	@Select("<script>"
			...
			+ "AND bef_no=#{bef_no}"
			+ "</script>")
	public List<EmrNewDataVO> selectPanel(EmrNewPageVO vo) throws Exception;
	...
	@Select("<script>"
			+ "<![CDATA["
			+ "SELECT "
			+ "bpt_birth, bpt_ptno, bpt_name, bpt_yage, bpt_telno, bpt_hpno, "
	...
	@Update("<script>"
			...
			+ "oec_lockdt = NULL, "
			+ "oec_loichost = NULL "
			+ "WHERE 0=0 AND oec_lockyn='1' "
			+ "AND oec_ptno = #{ptno} "
			+ "AND oec_loichost= #{uuid} "
			+ "</script>")
	public void updatLockClear(EmrOldParamVO vo) throws Exception;
	...
	@Update("<script>"
			...
			+ "]]>"
			+ "</script>")
	public void updatLockOtherClear(EmrOldParamVO vo) throws Exception;
	...
	@Select("<script>"
			...
			+ "]]>"
			+ "</script>")
	public List<EmrOpenDataVO> selectOpen(EmrOldParamVO vo) throws Exception;
	...
	@Select("<script>"
			...
			+ "]]>"
			+ "</script>")
	public String selectAdd1(EmrOldParamVO vo) throws Exception;
	
	@Select("<script>"
			+ "<![CDATA["
			+ "SELECT bem_no, bem_inout FROM emrsheet_mngr WHERE 0=0 AND bem_gubun=#{gubun} AND bem_inout=#{inout} AND bem_id=#{id} AND bem_no "
			+ "NOT IN ( SELECT oec_sid FROM emrchart  "
			+ "			WHERE 0=0  AND oec_ptno=#{ptno} AND oec_state='S' AND oec_wdate=convert(char,GETDATE(),112)) "
			+ "ORDER BY bem_seq DESC  "
			+ "]]>"
			+ "</script>")
	public List<EmrAddDataVO> selectAdd2(EmrOldParamVO vo) throws Exception;
	...
	@Select("<script>"
			...
			+ "]]>"
			+ "</script>")
	public EmrAttachTempVO selectAttach1(EmrAttachParamVO vo) throws Exception;
	...
	@Insert("<script>"
			...
			+ "]]>"
			+ "</script>")
	public void insertAttach2(EmrAttachParamVO vo) throws Exception;
	...
	@Select("<script>"
			...
			+ "]]>"
			+ "</script>")
	public EmrAttachTempVO selectAttach2(EmrAttachParamVO vo) throws Exception;
	...
	@Select("<script>"
			...
			+ "]]>"
			+ "</script>")
	public List<EmrAttachDataVO> selectAttach3(EmrAttachParamVO vo) throws Exception;
	...
	@Select("<script>"
			...
			+ "</if>"
			+ "</script>")
	public List<EmrAuthDataVO> selectAuth(EmrAuthParamVO vo) throws Exception;
