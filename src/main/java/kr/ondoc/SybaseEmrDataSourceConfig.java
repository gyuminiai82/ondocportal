...
@Configuration
@MapperScan(value="kr.ondoc.mapper.sybaseemr", sqlSessionFactoryRef="firstSqlSessionFactory2")
public class SybaseEmrDataSourceConfig {
	@Bean
	public DataSource sybaseDataSource2() throws IOException {
		...
		hikariConfig.setJdbcUrl("jdbc:log4jdbc:sybase:Tds:"+ip+":"+port+"?ServiceName=StEmr&CharSet=utf8");
	...
	@Bean 
	public SqlSessionFactory firstSqlSessionFactory2(DataSource sybaseDataSource2, ApplicationContext applicationContext) throws Exception 
	{
		SqlSessionFactoryBean sqlSessionFactoryBean = new SqlSessionFactoryBean();
		sqlSessionFactoryBean.setDataSource(sybaseDataSource2);
